...
* @type {{id,name,abbrev}}
*/
export const stateMapping = [ { name: "", id: "", abbrev: ""},
...
export function getStateById(id){
 return _.find(stateMapping, function(x){ return x.id == id })
}

export const countryMapping = [ {name:"", id: "", abbrev: ""},
...
export function getCountryById(id){
 return _.find(countryMapping, function (x){ return x.id == id; })
}
