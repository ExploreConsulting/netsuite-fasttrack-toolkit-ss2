...
(function (factory) {
     ...
     */
    var ExpCostSublist = /** @class */ (function (_super) {
        __extends(ExpCostSublist, _super);
        function ExpCostSublist() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        __decorate([
            Sublist_1.SublistFieldType.freeformtext
        ...
        return ExpCostSublist;
    }(Sublist_1.SublistLine));
    exports.ExpCostSublist = ExpCostSublist;
    /**
     * The Billable Items (itemcost) sublist fields
     */
    var ItemCostSublist = /** @class */ (function (_super) {
        __extends(ItemCostSublist, _super);
        function ItemCostSublist() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        __decorate([
            Sublist_1.SublistFieldType.freeformtext
