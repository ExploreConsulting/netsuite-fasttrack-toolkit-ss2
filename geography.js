...
define(["require", "exports", "./lodash"], function (require, exports, _) {
    ...
    * 4/13/2018 RMH Added Australia, Japan, China, Mexico and United Kingdom to support other State/Province/County lists
    * @type {{id,name,abbrev}}
    */
    exports.stateMapping = [{ name: "", id: "", abbrev: "" },
        ...
        { name: "Baja California Norte", id: 501, abbrev: "BCN" },
        ...
        { name: "Distrito Federal", id: 508, abbrev: "DF" },
    ...
    function getStateById(id) {
        return _.find(exports.stateMapping, function (x) { return x.id == id; });
    }
    exports.getStateById = getStateById;
    exports.countryMapping = [{ name: "", id: "", abbrev: "" },
    ...
    function getCountryById(id) {
        return _.find(exports.countryMapping, function (x) { return x.id == id; });
    }
